...
import com.message.mymessageapp.Adapter.TopStatusAdapter;
import com.message.mymessageapp.Adapter.UsersAdapter;
import com.message.mymessageapp.Model.Status;
import com.message.mymessageapp.Model.User;
import com.message.mymessageapp.Model.UserStatus;
import com.message.mymessageapp.databinding.ActivityMainBinding;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.invite:
                ...
                String shareBody = "Download this application ";
                String sharesub = "iMessage";

                shareIntent.putExtra(Intent.EXTRA_SUBJECT,sharesub);
                shareIntent.putExtra(Intent.EXTRA_TEXT,shareBody);

                startActivity(Intent.createChooser(shareIntent,"Share Using"));
                //           haToast.makeText(this, "Invite clicked.", Toast.LENGTH_SHORT).show();
                break;
            case R.id.settings:
