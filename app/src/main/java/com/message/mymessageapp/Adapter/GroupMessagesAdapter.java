package com.message.mymessageapp.Adapter;
...
import com.message.mymessageapp.Model.Message;
import com.message.mymessageapp.Model.User;
import com.message.mymessageapp.R;
import com.message.mymessageapp.databinding.DeleteDialogBinding;
import com.message.mymessageapp.databinding.ItemReceiveGroupBinding;
import com.message.mymessageapp.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ReactionPopup popup = new ReactionPopup(context,config,(pos) ->{
            ...
            return true;        //true is closing popup and false is requesting popup
        });
        ...
        if (holder.getClass() == SentViewHolder.class){
            ...
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    view = LayoutInflater.from(context).inflate(R.layout.delete_dialog, null);
